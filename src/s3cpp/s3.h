...
public:
  ...
  ListObjects(const std::string &bucket, const ListObjectsInput &options = {});
  std::expected<ListAllMyBucketsResult, Error>
  ListBuckets(const ListBucketsInput &options = {});
  ...
  DeleteObject(const std::string &bucket, const std::string &key,
  ...
  HeadBucket(const std::string &bucket, const HeadBucketInput &options = {});
  std::expected<HeadObjectResult, Error>
  HeadObject(const std::string &bucket, const std::string &key,
   ...
   */
  std::expected<ListObjectsResult, Error>
  deserializeListObjectsResult(const std::vector<XMLNode> &nodes,
                               const int maxKeys);
  std::expected<ListAllMyBucketsResult, Error>
  deserializeListBucketsResult(const std::vector<XMLNode> &nodes,
                               std::optional<int> maxBuckets);
  std::expected<PutObjectResult, Error> deserializePutObjectResult(
      const std::map<std::string, std::string, LowerCaseCompare> &headers);
  std::expected<DeleteObjectResult, Error> deserializeDeleteObjectResult(
      const std::map<std::string, std::string, LowerCaseCompare> &headers);
  std::expected<CreateBucketResult, Error> deserializeCreateBucketResult(
      const std::map<std::string, std::string, LowerCaseCompare> &headers);
  std::expected<HeadBucketResult, Error> deserializeHeadBucketResult(
      const std::map<std::string, std::string, LowerCaseCompare> &headers);
  std::expected<HeadObjectResult, Error> deserializeHeadObjectResult(
      const std::map<std::string, std::string, LowerCaseCompare> &headers);
